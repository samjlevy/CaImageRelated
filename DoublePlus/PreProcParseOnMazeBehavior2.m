function [onMazeFinal,behTable] = ParsePlusMazeBehavior2(xAVI,yAVI,v0,obj,onMaze)
...
nStartLocs = num2str(input('How many possible start/end locations are there?','s'));
