function allPFtime = AllTimeInField (place_maps_file, place_stats_file, placeField)
...
if nargin==2 || runAll==1
    ...
    for thisCell = 1:numCells
        for thisField = 1:numFields
            if any(PFpixels{thisCell,thisField})
                logicalInPF = ismember(PFpixels{thisCell,thisField},linIndTotal);
