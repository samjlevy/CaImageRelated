function [StudyLCorrs, StudyRCorrs, TestLCorrs, TestRCorrs, numCells] = PVcorrAllCondSplitVS(TMap_gaussSplit, RunOccMap, posThresh, threshAndConsec)
%This version takes the same (exactly the same) inputs as PFcorrAllCondSelf
%and does the comparisons across conditions
