function [pvCorrs, meanCorr, numCellsUsed, numNans, shuffPVcorrs, shuffMeanCorr, PVdayPairs ]=...
    MakePVcorrsWrapper2allToAll(trialbytrial, shuffleWhat, shuffleDim, numPerms, pooledCompPairs,...
...
for dpI = 1:numDayPairs
    for cpI = 1:length(pooledCompPairs)
        ...
        %Run PV
        [pvCorrs{dpI,cpI},meanCorr{dpI,cpI},numCellsUsed{dpI,cpI},numNans{dpI,cpI}] = PopVectorCorrsSmallTMapsAllToAll(...
