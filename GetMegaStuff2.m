...
for thisFile = 1:length(allfiles)
    ...
    switch sessionType(thisFile)
        case 1
            [bounds, ~, ~, ~, correct, lapNumber] = GetBlockDNMPbehavior...
    ...
    for block = 1:4
        ...
        lapNumber.(ss{block}).correct =...
            lapNumber.(ss{block})(correct.(ss{block}));
        
        badLaps(thisFile).(ss{block}) =...
            [bounds.(ss{block})(correct.(ss{block})==0,1)...
            bounds.(ss{block})(correct.(ss{block})==0,2)];
        
        lapNumber.(ss{block}).wrong=...
            lapNumber.(ss{block})(correct.(ss{block})==0);
    end
